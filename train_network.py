...
def train_network(weights_file="weights.hdf5", classpath="Preproc/Train/", epochs=500, batch_size=20, val_split=0.25,tile=False):
    np.random.seed(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=2000, type=int, help="Number of iterations to train for")
